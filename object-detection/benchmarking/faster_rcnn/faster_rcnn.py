...
``python detectron_train_v1.py --fold 1 --version detectron  --max_iters 1 --batch_size 8 --lr 0.00025 --gpu 0 --num_workers 4 --log True --save True --project capstone-project --name faster_rcnn_R_50_FPN_3x --data_path /Users/mraoaakash/Documents/research/capstone_project/object-detection/benchmarking/datasets/NuCLSEvalSet/detectron/master/npsave --image_dir /Users/mraoaakash/Documents/research/capstone_project/object-detection/benchmarking/datasets/NuCLSEvalSet/detectron//master/images --api_key 0 --config_info COCO-Detection/faster_rcnn_R_50_FPN_3x.yaml
``'''
